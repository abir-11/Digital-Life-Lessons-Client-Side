    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white shadow-lg rounded-3xl overflow-hidden flex flex-col sm:flex-row w-full max-w-4xl">
        ...
        <div className="w-full sm:w-1/2 p-10">
          ...
          <div className='text-center font-medium text-xl text-base-200 my-3'>or</div>
          <button onClick={handleGoogleSubmit} className="btn bg-white text-black border-[#e5e5e5] hover:bg-primary hover:text-white w-full mb-4">
            Login with Google
          </button>
